...
namespace SyncPrem.Pipeline.Host.Cli.Sync.Hosting
{
	...
	/// </summary>
	public class PipelineHostConsoleApplication : SyncExecutableApplicationFascade
	{
		...
		public static void OnDependencyMagic(IDependencyManager dependencyManager)
		{
			...
			dependencyManager.AddResolution<SyncExecutableApplicationFascade>(string.Empty, false, new SingletonWrapperDependencyResolution<SyncExecutableApplicationFascade>(TransientActivatorAutoWiringDependencyResolution<PipelineHostConsoleApplication>.From(dependencyManager)));
