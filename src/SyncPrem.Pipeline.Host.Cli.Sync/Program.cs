...
using SyncPrem.Pipeline.Host.Cli.Sync.Hosting;

using TextMetal.Middleware.Solder.Executive;

namespace SyncPrem.Pipeline.Host.Cli.Sync
{
	/// <summary>
	...
	internal static class Program
	{
		...
		{
			return SyncExecutableApplicationFascade.Run<PipelineHostConsoleApplication>(args);
		}
