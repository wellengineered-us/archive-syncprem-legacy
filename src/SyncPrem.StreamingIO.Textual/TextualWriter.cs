...
namespace SyncPrem.StreamingIO.Textual
{
	public abstract class TextualWriter : MarshalByRefObject, IDisposable
	{
		...
		public abstract void WriteFooterRecords(IEnumerable<IDelimitedTextualFieldSpec> specs, IEnumerable<IPayload> footers);

		public abstract void WriteHeaderFields(IEnumerable<IDelimitedTextualFieldSpec> specs);
